                ...
                <div class="card card-info">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            {{ Form::select('category_id', [null => 'Please choose category'] + $categories, $book->category_id, ['class' => 'form-control']) }}
                        </div>

                        <div class="form-group">
                            <label>Maximum number of date you can borrow this book</label>
                            <input type="text" name="maxdate" class="form-control" value="{{ $book->maxdate }}">
                        </div>
                        ...
                        <div class="form-group">
                            <label>Summary</label>
                            <textarea name="summary" rows="5" class="form-control">{{ $book->summary }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
